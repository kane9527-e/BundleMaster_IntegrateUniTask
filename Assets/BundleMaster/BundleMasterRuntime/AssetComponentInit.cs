...
namespace BM
{
    public static partial class AssetComponent
    {
        ...
        /// 初始化
        /// </summary>
        public static async UniTask Initialize(string bundlePackageName, string secretKey = null)
        {
            ...
            UniTaskCompletionSource fileTcs = new UniTaskCompletionSource();
            ...
            UniTaskCompletionSource dependTcs = new UniTaskCompletionSource();
            ...
            UniTaskCompletionSource groupTcs = new UniTaskCompletionSource();
