...
namespace BM
{
    ...
    public static class VerifyHelper
    {
        ...
        /// 得到一个路径下文件的CRC32
        /// </summary>
        internal static async UniTask<uint> GetFileCRC32(string filePath)
        {
            uint fileCRC32;
        ...
        /// </summary>
        internal static async UniTask<byte[]> GetDecryptDataAsync(string filePath, WebLoadProgress loadProgress = null, char[] secretKey = null)
        {
            byte[] encryptData;
            UniTaskCompletionSource tcs = new UniTaskCompletionSource();
            using (UnityWebRequest webRequest = UnityWebRequest.Get(filePath))
